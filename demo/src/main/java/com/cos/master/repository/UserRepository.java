...
public interface UserRepository extends JpaRepository<UserEntity, Integer> {
	...
	@Query(value = "select id,firstname,lastname,user_id,mobile,email,password from user_info where email = :email", nativeQuery = true)
	public List<Object[]> fetchByUserInfo(@Param("email") String email);
...
//	public List<Object[]> getFamilylInfo(@Param("userId") String userId);
	...
	@Query(value = "select father_upload_medical_history from family_info where id =:userId", nativeQuery = true)
	public byte[] getFamilyInfo(@Param("userId") String userId);

	@Query(value = "select mother_upload_medical_history from family_info where id =:userId", nativeQuery = true)
	public byte[] getFamilyInfo1(@Param("userId") String userId);
	...
	public int updatePassword(@Param("updatedPassword") String updatedPassword,
			@Param("moblieNumber") String moblieNumber);
...
//	public int updateBloodGroup(@Param("bloodGroup") String bloodGroup,@Param("userId") int userId);
	...
	public int updateFatherUploadMedicalHistory(
			@Param("father_upload_medical_history") byte[] father_upload_medical_history, @Param("id") int id);
	...
	public int updateMotherUploadMedicalHistory(
			@Param("mother_upload_medical_history") byte[] mother_upload_medical_history, @Param("id") int id);
	...
	public int updateSpouseUploadMedicalHistory(
			@Param("spouse_upload_medical_history") byte[] spouse_upload_medical_history, @Param("id") int id);
...
//	public int updateNominee2Name(@Param("nominee2_name") String nominee2_name,@Param("id") int id);
	...
	public int updateOtherNomineeOccupation(@Param("other_nominee_occupation") String other_nominee_occupation,
			@Param("id") int id);
...
//	@Modifying
//	@Transactional
//	@Query(value = "update user_info set firstname =?1, lastname=?2, dateOfBirth =?3, mobile=?4, gender=?5, maritalStatus =?6 ", nativeQuery = true)
//	public int saveUserInfoByMobile(String firstname,String lastname,String dateOfBirth, String mobile, String gender, String maritalStatus);
