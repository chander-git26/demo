...
//    	UserService userService = null;
	...
	public ResponseObject uploadImage(HttpServletRequest request, @RequestParam("userId") int UserId,
			@RequestParam("profile") MultipartFile file) throws IOException, SerialException, SQLException {
		try {
